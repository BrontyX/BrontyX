...
local BrontyX_Msg = ''  
if msgs < 100 then 
BrontyX_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BrontyX_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BrontyX_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BrontyX_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BrontyX_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BrontyX_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BrontyX_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BrontyX_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BrontyX_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
BrontyX_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BrontyX_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BrontyX_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BrontyX_Msg = 'رب التفاعل'  
end 
return BrontyX_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBrontyX(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,BrontyX_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'💢¦ عدد المجموعات الان » { '..#group..' }'..BrontyXk..''..BrontyX..'\n*💢┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if BrontyX_Msg and not Special(msg) then  
local BrontyX_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BrontyX_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫¦["..BrontyX_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/kenwa)}\n🚫¦["..BrontyX_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'kenwa')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'kenwa')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
------------------------------------------------------------------------
if text == 'تعطيل العمر' and Manager(msg) then
send(msg.chat_id_, msg.id_,'\n💢┇تم تعطيل العمر في المجموعه ...')  
database:set(bot_id.."age_chk"..msg.chat_id_,"close") 
end
if text == 'تفعيل العمر' and Manager(msg) then
send(msg.chat_id_, msg.id_,'\n💢┇تم تفعيل العمر في المجموعه ...')  
database:set(bot_id.."age_chk"..msg.chat_id_,"open") 
end


if text and text:match('^عمر (.*)$') and database:get(bot_id.."age_chk"..msg.chat_id_) == "open" then   
local Ttext = text:match('^عمر (.*)$') 
local InfoSearch = https.request('https://api.kenouk.com/age/?age='..URL.escape(Ttext))
fff = JSON.decode(InfoSearch)
i = 0
...
t = "\n⛔¦ قائمة المنع \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local BrontyX_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..BrontyX_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'kenwa')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كينو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كينو')
local BrontyX_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..BrontyX_Msg[math.random(#BrontyX_Msg)]..']') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كينو').." غادر" or text == 'غادر' then 
...
local KenouK = '👤¦ عدد الادمنيه : '..data.administrator_count_..
'\n\n🚷¦ عدد المطرودين : '..data.kicked_count_..
'\n\n👥¦ عدد الاعضاء : '..data.member_count_..
'\n\n📨¦ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n📯¦ اسم المجموعه : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, KenouK) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,KenouK,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'منشئ'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'ادمن' 
...
local photps = (KenouK.total_count_ or 0)
...
"خلينه نكبل🙈❤️",
"مارتاحلك😐",
"ادمن وكف الايدي ايععع",
"خلصن الحلوات اجو الحلوين",

}
local rdphoto = KenouKa[math.random(#KenouKa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, KenouK.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, KenouK.photos_[0].sizes_[1].photo_.persistent_id_,'🛤┐ '..rdphoto..'\n🎟┤ ايديك ← '..msg.sender_user_id_..'\n🎫┤ معرفك ← '..username..'\n📡┤ رتبتك ← '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n⭐️┤ تفاعلك ← '..Total_Msg(Msguser)..'\n💬┤ رسائلك ← '..Msguser..'\n🏆┤ مجوهراتك ← '..NUMPGAME..'\n🚸┘ السحكات ← '..edit..'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉')   
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n🎟┐ ايديك ← '..msg.sender_user_id_..'\n🎫┤ معرفك ← '..username..'\n📡┤ رتبتك ← '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n⭐️┤ تفاعلك ← '..Total_Msg(Msguser)..'\n💬┤ رسائلك ← '..Msguser..'\n🏆┤ مجوهراتك ← '..NUMPGAME..'\n🚸┘ السحكات ← '..edit..']\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉')   
else
...
KenouK = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,KenouK)  
...
KenouK = text:match("^اضف مجوهرات (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,KenouK)  
...
BrontyX = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BrontyX)
...
--------------------------------------------------------------------------------------------------------------
SourceBrontyX(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
KenouKn = '['..(Get_Re_Name or '')..']'
KenouKm = '['..data.first_name_..']'
local KenouK ={ 
'\n شكو غيرت اسمك  يا حلو 😹🌚',
'\n شهل اسم الفيطي '..KenouKm.. ' \n رجعه ؏ قديم \n '..KenouKn..'',
'\n  ها ها شو غيرت اسمك 🤔😹',
'\n شكو غيرت اسمك شنو قطيت وحده جديده 😹😹🌚',
'\n شو غيرت اسمك شنو تعاركت ويه الحب ؟😹🌞',
'\n ها ولك مو جان  اسمك   '..KenouKn..'  شكو غيرته ',
'\n شكو غيرت اسمك شسالفه ؟؟ 🤔🌞'
}
send(msg.chat_id_,msg.id_,KenouK[math.random(#KenouK)])
...
KenouKn = '['..(database:get(bot_id.."Chen:User:Name"..msg.sender_user_id_) or '')..']'
local KenouK ={ 
'\n شكو غيرت معرفك  يا حلو 😹🌚',
'\n  ها ها شو غيرت معرفك 🤔😹',
'\n شكو غيرت معرفك شنو قطيت وحده جديده 😹😹🌚',
'\n شو غيرت معرفك شنو تعاركت ويه الحب ؟😹🌞',
'\n ها ولك مو جان  معرفك   '..KenouKn..'  شكو غيرته ',
...
------------------------------------------------------------------------
local BrontyXbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if BrontyXbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫¦["..BrontyXbot.."] \n") 
